...
import { DescriptionListEditorEditor } from '../elements/description/DescriptionListEditor';
...
export function editorFor(
  ...
  switch (model.type) {
    ...
    case 'dl':
      return (
        <DescriptionListEditorEditor
          {...(editorProps as EditorProps<ContentModel.DescriptionList>)}
        />
      );
    case 'dt':
